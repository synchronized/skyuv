...
file(COPY "${CMAKE_CURRENT_SOURCE_DIR}/skynet/lualib-src" DESTINATION "${SKYUV_SKYNET_PATCH_ROOT}")
execute_process(
  COMMAND
...
if(NOT SKYUV_SKYNET_LUA_SOCKET_PATCH_RESULT EQUAL 0)
  message(FATAL_ERROR "应用 Skynet Lua socket Winsock 补丁失败：${SKYUV_SKYNET_LUA_SOCKET_PATCH_ERROR}")
endif()
execute_process(
  COMMAND
...
if(NOT SKYUV_SKYNET_CLIENT_SOCKET_PATCH_RESULT EQUAL 0)
  message(FATAL_ERROR "应用 Skynet client socket 适配补丁失败：${SKYUV_SKYNET_CLIENT_SOCKET_PATCH_ERROR}")
endif()
execute_process(
  COMMAND
...
if(NOT SKYUV_SKYNET_NETPACK_POINTER_PATCH_RESULT EQUAL 0)
  message(FATAL_ERROR "应用 Skynet netpack 标准指针运算补丁失败：${SKYUV_SKYNET_NETPACK_POINTER_PATCH_ERROR}")
endif()
